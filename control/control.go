...
func NewControl() Control {
	...
	return Control{
		...
		influxdb2.NewClient("http://r4-influxdb.ricplt:8086", "client"),
	}
}
func create_db() {
	//Create a database named kpimon in influxDB
	_, err := http.Post("http://r4-influxdb.ricplt:8086/query?q=create%20database%20kpimon", "", nil)
	if err != nil {
...
// 	//O-RAN.WG3.E2SM-KPM-v02.00 8.2.1.3.1 E2SM-KPM Indication Header Format 1
...
// 	//O-RAN.WG3.E2SM-KPM-v02.00 8.2.1.4.2 E2SM-KPM Indication Message Format 2
...
// 		log.Printf("PMContainerCount: %d", indMsgFormat2.PMContainerCount)

// 		for PMCCounter := 0; PMCCounter < indMsgFormat2.PMContainerCount; PMCCounter++ {
// 			flag = false
...
// 			log.Printf("PMContainer[%d]: ", PMCCounter)

// 			pmContainer := indMsgFormat2.PMContainers[PMCCounter]
...
// 					for reportCounter := 0; reportCounter < cellResourceReportCount; reportCounter++ {
// 						log.Printf("CellResourceReport[%d]: ", reportCounter)

// 						cellResourceReport := oDU.CellResourceReports[reportCounter]
...
// 						for sPCCounter := 0; sPCCounter < servedPlmnPerCellCount; sPCCounter++ {
// 							log.Printf("ServedPlmnPerCell[%d]: ", sPCCounter)

// 							servedPlmnPerCell := cellResourceReport.ServedPlmnPerCells[sPCCounter]
...
// 								for sliceCounter := 0; sliceCounter < slicePerPlmnPerCellCount; sliceCounter++ {
// 									log.Printf("SlicePerPlmnPerCell[%d]: ", sliceCounter)

// 									slicePerPlmnPerCell := servedPlmnPerCell.DUPM5GC.SlicePerPlmnPerCells[sliceCounter]
...
// 									for fQICounter := 0; fQICounter < fQIPERSlicesPerPlmnPerCellCount; fQICounter++ {
// 										log.Printf("5QIPerSlicesPerPlmnPerCell[%d]: ", fQICounter)

// 										fQIPERSlicesPerPlmnPerCell := slicePerPlmnPerCell.FQIPERSlicesPerPlmnPerCells[fQICounter]
...
// 								for pQRCounter := 0; pQRCounter < perQCIReportCount; pQRCounter++ {
// 									log.Printf("PerQCIReports[%d]: ", pQRCounter)

// 									perQCIReport := servedPlmnPerCell.DUPMEPC.PerQCIReports[pQRCounter]
...
// 					for UPPFCounter := 0; UPPFCounter < cuUPPFContainerItemCount; UPPFCounter++ {
// 						log.Printf("CU-UP PF Container Item [%d]: ", UPPFCounter)

// 						cuUPPFContainerItem := oCUUP.CUUPPFContainerItems[UPPFCounter]
...
// 						for UPPlmnCounter := 0; UPPlmnCounter < cuUPPlmnCount; UPPlmnCounter++ {
// 							log.Printf("CU-UP Plmn [%d]: ", UPPlmnCounter)

// 							cuUPPlmn := cuUPPFContainerItem.OCUUPPMContainer.CUUPPlmns[UPPlmnCounter]
...
// 								for sliceCounter := 0; sliceCounter < sliceToReportCount; sliceCounter++ {
// 									log.Printf("SliceToReport[%d]: ", sliceCounter)

// 									sliceToReport := cuUPPlmn.CUUPPM5GC.SliceToReports[sliceCounter]
...
// 									for fQICounter := 0; fQICounter < fQIPERSlicesPerPlmnCount; fQICounter++ {
// 										log.Printf("5QIPerSlicesPerPlmn[%d]: ", fQICounter)

// 										fQIPERSlicesPerPlmn := sliceToReport.FQIPERSlicesPerPlmns[fQICounter]
...
// 								for repCounter := 0; repCounter < cuUPPMEPCPerQCIReportCount; repCounter++ {
// 									log.Printf("PerQCIReport[%d]: ", repCounter)

// 									cuUPPMEPCPerQCIReport := cuUPPlmn.CUUPPMEPC.CUUPPMEPCPerQCIReports[repCounter]
...
// 					for oDUUECounter := 0; oDUUECounter < oDUUE.CellResourceReportItemCount; oDUUECounter++ {
// 						cellResourceReportItem := oDUUE.CellResourceReportItems[oDUUECounter]
...
// 						for UeRRCounter := 0; UeRRCounter < cellResourceReportItem.UeResourceReportItemCount; UeRRCounter++ {
// 							ueResourceReportItem := cellResourceReportItem.UeResourceReportItems[UeRRCounter]
...
// 					for CRRCounter := 0; CRRCounter < oCUCPUE.CellResourceReportItemCount; CRRCounter++ {
// 						cellResourceReportItem := oCUCPUE.CellResourceReportItems[CRRCounter]
...
// 						for UeRRICounter := 0; UeRRICounter < cellResourceReportItem.UeResourceReportItemCount; UeRRICounter++ {
// 							ueResourceReportItem := cellResourceReportItem.UeResourceReportItems[UeRRICounter]
...
// 					for CRRICounter := 0; CRRICounter < oCUUPUE.CellResourceReportItemCount; CRRICounter++ {
// 						cellResourceReportItem := oCUUPUE.CellResourceReportItems[CRRICounter]
